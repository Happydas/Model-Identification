...
correct_prediction = [7, 9, 10, 10, 10, 10, 10, 10, 10, 10]
def visualize(sample, prediction):
    ...
    layout = {
        ...
        "title": "Correct Prediction against Samples for 1% noise",
...
fig.update_layout(
    title={
        'text': " Number of correct predictions over samples for 1% noise",
        'y':0.9,
        'x':0.5,
        'xanchor': 'center',
        'yanchor': 'top'})
